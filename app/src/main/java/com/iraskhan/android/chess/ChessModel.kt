...
class ChessModel {
    ...
    fun reset() {
        ...
        piecesBox.add(ChessPiece(4, 0, ChessPlayer.WHITE, ChessRank.KNIGHT, R.drawable.knight_white))
        piecesBox.add(ChessPiece(4, 7, ChessPlayer.BLACK, ChessRank.KNIGHT, R.drawable.knight_black))
    }
